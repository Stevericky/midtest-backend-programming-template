...
module.exports = (app) => {
  ...
  route.post(
    '/minibank',
    authenticationMiddleware,
    celebrate(usersValidator.createUserMinibank),
    usersControllers.createUserMinibank
  );

  route.get(
    '/minibank/telpon',
    authenticationMiddleware,
    celebrate(usersValidator.getminibanktelp),
    usersControllers.getminibanktelp
  );
  route.put(
    '/minibank/telpon/:id',
    authenticationMiddleware,
    celebrate(usersValidator.updateminibanktelp),
    usersControllers.updateminibanktelp
  );
  route.delete(
    '/minibank/:id',
    authenticationMiddleware,
    usersControllers.deleteminibank
  );
};
